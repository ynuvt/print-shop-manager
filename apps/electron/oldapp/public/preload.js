...
contextBridge.exposeInMainWorld("electron", {
  ...
  onJobsUpdate: (callback) => {
    // Renderer subscribes here; data comes from mainWindow.webContents.send("jobs-update", jobs).
    // We keep a single listener to avoid duplicate updates after reloads/remounts.
