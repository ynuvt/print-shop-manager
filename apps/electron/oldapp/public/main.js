...
function setupRealtimeListener() {
  ...
  // onSnapshot fires once immediately with current matching docs, then again on every change.
  jobListener = db
    .collection("jobs")
    ...
    .onSnapshot(
      (snapshot) => {
        ...
        if (mainWindow) {
          // Push fresh jobs to renderer via IPC.
          // App.jsx listens through preload's onJobsUpdate and updates React state.
